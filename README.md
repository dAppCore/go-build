...
- Exposes the action-style control surface: `core-version`, `go-version`, `node-version`, `wails-version`, `build`, `sign`, `package`, `build-name`, `build-platform`, `build-tags`, `build-obfuscate`, `nsis`, `deno-build`, `wails-build-webview2`, and `build-cache`
